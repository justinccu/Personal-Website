              ...
              >
                <div
                  ...
                  style={title === 'Manhattan, First Time in the US' ? {
                    backgroundImage: 'url("../entities/images/Manhattan.JPEG")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'Denmark, with my Amazing Friend!' ? {
                    backgroundImage: 'url("../entities/images/Denmark.JPEG")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'Volleyball, Freshmen in CCU' ? {
                    backgroundImage: 'url("../entities/images/volleyball_freshmen.JPEG")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'Becoming a School Ambassador' ? {
                    backgroundImage: 'url("../entities/images/flagship.jpeg")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'Ole Miss, First Day in Mississippi' ? {
                    backgroundImage: 'url("../entities/images/Olemiss_firstday.jpeg")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'Atlanta, Thanksgiving Trip' ? {
                    backgroundImage: 'url("../entities/images/Gatech.jpeg")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'Osaka, Japan Adventure' ? {
                    backgroundImage: 'url("../entities/images/Osaka.jpeg")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center 83%',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'JJ Lin Concert Experience' ? {
                    backgroundImage: 'url("../entities/images/JJLin.JPG")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'Graduation from CCU!' ? {
                    backgroundImage: 'url("../entities/images/graduate.jpeg")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : title === 'ITRI Internship' ? {
                    backgroundImage: 'url("../entities/images/ITRI.jpeg")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat'
                  } : {}}
